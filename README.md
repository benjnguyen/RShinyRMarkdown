...
The code is not my own work (although there are some very slight modifications); it serves as a personal tutorial for how to develop more complicated web applications in R.
